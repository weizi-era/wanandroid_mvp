...
public class Utils {
    ...
    public static int getColor(Context context) {
        ...
        int defaultColor = ContextCompat.getColor(context, R.color.purple_200);
     ...
     * 设置loading的颜色 加载布局
     */
    public static void setLoadingColor(LoadService loadService) {
        loadService.setCallBack(LoadingCallback.class, new Transport() {
            ...
            public void order(Context context, View view) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    progressBar.setIndeterminateTintList(Utils.getOneColorStateList(context));
                }
            }
        });
    }
