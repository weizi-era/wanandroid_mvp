...
public abstract class BaseFragment<P extends IPresenter> extends SupportFragment implements IFragment, FragmentLifecycleable, IView {
    ...
    public void showMessage(@NonNull @NotNull String message) {
        DialogUtil.showDialog(_mActivity, message);
    }
